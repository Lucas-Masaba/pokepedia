...
const Pokemon = () => {
  ...
  } = useGetPokemonDescriptionQuery(name);
    ...
    <div>
      ...
      {data && (
        <div
          ...
          style={colorChange(data.types[0].type.name)}
        >
          <section style={colorChange(data.types[0].type.name)}>
            ...
            <div className="flex flex-col items-center">
              <h3 className="font-bold font-Mochiy">
          ...
          <section className="rounded-t-[20px] bg-white text-black p-3 pt-6">
            <div className="pl-2">
              {speciesData && (
                <p className="pb-2 md:flex md:justify-center">
                  {speciesData.flavor_text_entries[0].flavor_text}
                </p>
              )}
            </div>
            <div className="pr-2">
              <h1 className="text-[22px] text-orange-600 font-bold md:flex md:justify-center">
                Data
              </h1>
                  ...
                  <li>
                    ...
                    {data.types.map((aType, index) => (
                      <>
                        <span
                          key={index}
                          style={colorChange(aType.type.name)}
