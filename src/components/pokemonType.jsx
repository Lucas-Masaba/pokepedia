                ...
                .map((poke, index) => (
                  ...
                  >
                    <li
                      ...
                      className={` flex items-center justify-between flex-col shadow-xl border-2 h-[300px] w-[100%] p-10 m-30 rounded-xl transition ease-in-out delay-150 hover:shadow-cyan-500 hover:-translate-y-1 ${colorChange(
                        type
                      )}`}
                    >
